...
The three published packages and the demo are all TypeScript; the end-to-end suite under
`demo/__integration__` is the last JavaScript left, and it goes with Jest. The declarations
